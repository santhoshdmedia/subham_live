        ...
        <div className="flex lg:flex-row flex-col">
          ...
          <div className="lg:flex md:flex lg:w-[60%]">
            <div className="lg:w-[40%] md:w-[40%] ">
              <h4 className="font-bold font-pri_head text-lg my-2 flex items-center gap-1">
                <ICON_HELPER.PHONE_ICON className="text-primary" /> Tour contact
              </h4>
              <p className="mb-1 hover:text-primary hover:opacity-100 font-pri_para opacity-80">+91 9087143535</p>
              <h4 className="font-bold font-pri_head text-lg mb-2 flex items-center gap-1">
                <ICON_HELPER.PHONE_ICON className="text-primary" /> Customer Support
              </h4>
        ...
        <div className="mt-4 flex flex-col lg:flex-row justify-between items-center space-y-5 lg:space-y-0">
          <div className="flex space-x-4">
            {socialIcons.map((Icon) => (
              <Link key={Icon.id} to={Icon.path} target="_blank" className="text-gray-400 hover:text-white hover:bg-primary hover:border-primary rounded-full border p-1">
