  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="relative w-full h-[250px] sm:h-[300px] md:h-[400px]">
        <img src={IMAGE_HELPER.india} alt="Banner" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
          <div className="text-white space-y-2">
            <p className="flex items-center gap-2 text-sm sm:text-base">
              ...
              <span className="text-sky-400 font-semibold">Indian Packages</span>
            </p>
            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold font-pri_head">Indian Packages</h1>
